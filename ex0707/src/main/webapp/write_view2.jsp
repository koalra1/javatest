...
<html>
   ...
   <form action="./content_view2.jsp">
      ...
      <label>공지글등록</label><br>
         <input type="radio" id="n_yes" name="n_wirte" value="n_yes">공지글등록<br>
         <input type="radio" id="n_no" name="n_wirte" value="n_no">공지글취소<br>
      <label>글카테고리</label><br>
         <input type="checkbox" id="screen" name="category" value="screen">영화<br>
         <input type="checkbox" id="trian" name="category" value="trian">운동<br>
